...
from networks.cnn1d_NiN import NiN_CNN1D_TrafficClassification  #using other work's model that uses NiN
...
if __name__ == '__main__':
    ...
    parser.add_argument('--NiN_model', default='False', help='argument to train the nin model instead. give \'true\' to use the NiN model, or else dont put this argument')
    ...
    if 'true' in args.NiN_model:
        ...
        model = NiN_CNN1D_TrafficClassification(input_ch=1, num_classes=classes).to(device)
    else:
